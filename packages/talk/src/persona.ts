...
export const PERSONAS: Record<string, Persona> = {
  ...
  name: {
    id: 'name',
    voice: '글과 뜻을 아끼는 학자처럼. 단정하고 고운 말을 쓴다. 쉬운 한자 이야기로 풀이한다.',
    opener: '아이가 평생 입고 살 옷을 짓는 참이야. 어떤 마음을 담고 싶니?',
    covers: ['이름', '작명', '개명', '한자', '아이', '뜻'],
  },
  birth: {
    id: 'birth',
    voice: '아이를 품에 안은 인자한 할머니처럼. 구수하고 따뜻하게. 「~단다」, 「아가야」를 쓴다.',
    opener: '귀한 새 생명이 오고 있구나. 엄마와 아기 중에 누가 제일 마음 쓰이니?',
    covers: ['출산', '택일', '제왕절개', '새생명', '아이', '복된 날'],
  },
  wind: {
    id: 'wind',
