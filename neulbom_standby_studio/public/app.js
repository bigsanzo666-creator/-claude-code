...
const CHAMBER_FLOWS = {
  // 1. 도화신령 — 연애 · 매력
  dohwa: [
    { hook: true, say: "{이름}. 말 안 해도 안다.\n네 연못에 얼굴 하나가 계속 비치고 있어." },
    {
  ...
  // 3. 실신령 — 궁합 · 인연
  yeon: [
    { hook: true, say: "{이름}. 네 손목에 실이 하나 걸려 있다.\n끝을 따라가 봤더니 사람이 있더구나." },
    {
  ...
  // 4. 삼합신령 — 사주 × 관상 × 손금
  samhap: [
    { hook: true, say: "{이름}. 네 팔자와 얼굴과 손을 겹쳐 봤다.\n셋 중 하나가 다른 말을 하고 있더군." },
    {
      say: "사주는 이미 받았다.\n이제 네 얼굴과 손을 보자.",
      fields: [
  ...
  // 5. 작명신령 — 평생 이름
  jakmyeong: [
    { hook: true, say: "{이름}. 그 아이 이름 부를 때마다\n머리 위로 떨어질 소리, 내가 벌써 들었다." },
    {
      say: "이름은 평생 불릴 소리다.\n아이 성씨부터 알려다오.",
      fields: [
  ...
  // 6. 삼신할매 — 출산 · 택일
  samsin: [
    { hook: true, say: "{이름}. 병원에서 받아 온 그 날짜들,\n그중에 기운이 유난히 무거운 날이 섞여 있다." },
    {
  ...
  // 7. 명경신령 — 나의 본질 · 재능
  myeonggyeong: [
    { hook: true, say: "{이름}. 거울은 거짓말을 안 한다.\n네가 요즘 너를 못 보고 있는 것까지 다 비쳤다." },
    {
      say: "거울 앞에 서기 전에,\n지금 뭘 하고 사는지부터.",
      fields: [
  ...
  // 8. 재신령 — 돈그릇 · 재물
  jae: [
    { hook: true, say: "{이름}. 네 곳간 문을 열어 봤다.\n들어온 자리보다 새는 자리가 먼저 보이더군." },
    {
      say: "네 곳간은 지금 어떤 상태지?",
      fields: [
  ...
  // 9. 산신령 — 자녀 · 가족 · 노후
  san: [
    { hook: true, say: "{이름}. 산에서는 다 내려다보인다.\n네가 요즘 누구 때문에 뒤척이는지까지." },
    {
      say: "누구 이야기를 들으러 왔느냐.",
      fields: [
  ...
  // 10. 풍신령 — 시기 · 타이밍
  pung: [
    { hook: true, say: "{이름}. 바람이 먼저 와서 일러주더군.\n네가 무언가 쥐고 못 놓고 있다고." },
    {
